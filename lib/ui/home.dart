...
class _HomeState extends State<Home> {
  ...
  void fetchWeatherData() async {
    ...
    var consolidatedWeather = json.decode(weatherResult.body)['consolidated_weather'];
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          DetailPage(consolidatedWeatherList: consolidatedWeatherList, selectedId: index, location: location,)));
                        },
                        child: Container(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("${consolidatedWeatherList[index]['the_temp'].round()}C",
                                style: TextStyle(
                                  fontSize: 17,

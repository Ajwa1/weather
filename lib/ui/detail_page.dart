...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: myConstants.seconadryColor,
      appBar: AppBar(
        centerTitle: true,
        backgroundColor: myConstants.seconadryColor,
        elevation: 0.0,
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  weatherItem(
                                    text: 'Wind Speed',
                                    value: widget.consolidatedWeatherList[selectedIndex]['wind_speed'].round(),
                                    unit: 'km/h',
                      ...
                      child: SizedBox(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder:
                              ...
                              widget.consolidatedWeatherList[index]['weather_state_name'];
                              var futureImageURL = 
                              futureWeatherName.replaceAll(' ', '').toLowerCase();
                              var myDate = 
                              DateTime.parse(widget.consolidatedWeatherList[index]['applicable_date']);
                              var currentDate =
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: myConstants.seconadryColor.withOpacity(.1),
                                        spreadRadius: 5,
                                        blurRadius: 20,
